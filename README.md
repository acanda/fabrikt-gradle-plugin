...
fabrikt {
    generate("dog") {
        ...
        client {
            ...
            groupByTag = disabled
            okHttpNonNullResponsePayloads = disabled
        ...
        model {
            ...
            faultTolerantOpenEnums = disabled
            ignoreUnknownProperties = disabled
            serializationLibrary = Jackson2
...
| client.groupByTag                            | Enables grouping clients based on the first tag rather than paths.<br/>Values: `enabled`, `disabled`, `true`, `false`.                                                                                                                                                                                                             | `disabled`                        |
| client.okHttpNonNullResponsePayloads         | Enables makes `ApiResponse.data` non-null. Only for OkHttp clients.<br/>Values: `enabled`, `disabled`, `true`, `false`.                                                                                                                                                                                                            | `disabled`                        |
...
| model.faultTolerantOpenEnums                 | Enables converting the "open enum" pattern (an `anyOf` combining a string enum with an open `type: string`) into a fault-tolerant enum, i.e. an enum carrying the declared values plus an `UNRECOGNIZED` fallback, instead of collapsing the type to a plain `String`.<br/>Values: `enabled`, `disabled`, `true`, `false`.         | `disabled`                        |
...
| model.serializationLibrary                   | Specifies the serialization library to use for annotations in generated model classes.<br/>Values: `Jackson2`, `Jackson3`, `Kotlinx`.                                                                                                                                                                                              | `Jackson2`                        |
