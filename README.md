...
| model.serializationLibrary                   | Specifies the serialization library to use for annotations in generated model classes.<br/>Values: `Jackson`, `Jackson3`, `Kotlinx`.                                                                                                                                                                                               | `Jackson`                         |
